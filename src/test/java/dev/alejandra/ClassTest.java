...
public class ClassTest {
    ...
    void person_name_test() {
        Person person = new Person("perro", "12345678L", 1999, "Gonzalez");
    ...
    void person_ID_test() {
        Person person = new Person("gato", "12345678L", 1999, "Lopez");
    ...
    void person_ID_lenght_test() {
        Person person = new Person("gato", "12345678L", 1999, "Fernandez");
    ...
    void person_year_of_birth_test() {
        Person person = new Person("gato", "12345678L" , 1999, "Gutierrez");
